...
?>
			...
			<div class="hero">
				<ul class="slides">
					<li data-bg-image="images2/t1.jpg">
						<div class="container">
							<div class="slide-content">
							   <div class="c-img">
							   	   <img src="images2/p9.jpg" class="rounded mx-auto d-block">
							   </div>
							   <div class="info">
							   	    <h4>Maximilian Brochnow</h4>
							   	    <p>Postdoc</p>
							   	    <p><strong>Email:</strong>stefan.kraner@...</p>
							   	    <p><strong>Phone:</strong>03567></p>
							   	    <p><strong>Room no:</strong>12</p>
							   </div>
							   <div class="interest">
							   	   <h4>Research Interests</h4>
							   	   <h6>Tailoring amphiphilic organic molecules for self assembled photovoltaic materials</h6>

              ...
              <div class="card" style="width:590px">
                ...
                if (isset($_GET['device_id'])) 
                {
                  ...
                  $sql = "SELECT equipment.`device_name`, equipment.`device_image`,
                         ...
                         FROM `equipment`
                         LEFT JOIN `reservations` ON equipment.id = reservations.device_id
                         WHERE equipment.`id` = $device_id AND (reservations.`is_returned` = 0 OR reservations.`is_returned` IS NULL)";
